...
let myData = [
    ...
    new article("../media/image3.jpeg", 'A Guide To buisness At Any Age', 'Faisal Steele', new Date(2023, 0, 22), articleContent[2]),
    new article("../media/image4.jpeg", 'How To Make More Money By Doing Less', 'Samara Ho', new Date(2022, 4, 15), articleContent[3]),
    new article("../media/image5.jpeg", 'Why Markets Succeeds', 'Faisal Steele', new Date(2022, 3, 9), articleContent[4]),
    new article("../media/image6.jpeg", 'Protecting Critically Endangered Primates', 'Abby Hill', new Date(2022, 0, 10), articleContent[5]),
    new article("../media/image7.jpeg", 'Deforestation Continues at Alarming Rate', 'Samara Ho', new Date(2022, 8, 18), articleContent[6]),
    new article("../media/image8.jpeg", 'From Silicon Valley to Wall Street', 'Nicholas Rhodes', new Date(2022, 3, 29), articleContent[7]),
]

export {article, myData};